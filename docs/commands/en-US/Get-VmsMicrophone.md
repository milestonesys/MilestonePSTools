...
online version: https://www.milestonepstools.com/commands/en-US/Get-VmsMicrophone/
schema: 2.0.0
---
...
### Id
```
Get-VmsMicrophone [-Id] <Guid[]> [<CommonParameters>]
```

### Path
```
Get-VmsMicrophone [-Path] <String[]> [<CommonParameters>]
```
...
### Example 4
```powershell
Get-VmsMicrophone -EnableFilter Disabled
```
