...
{
    [Cmdlet(VerbsCommon.Set, "MicrophoneSetting")]
    [RequiresVmsConnection()]
    public class SetMicrophoneSetting : ConfigApiCmdlet
    {
        ...
        {
            var settings = Microphone.DeviceDriverSettingsFolder.DeviceDriverSettings.First();
