...
namespace MilestonePSTools.DeviceCommands
{
    ...
    [Cmdlet(VerbsCommon.Set, "VmsDeviceGeneralSetting", DefaultParameterSetName = nameof(Device), SupportsShouldProcess = true)]
    [OutputType("None")]
    ...
    public class SetDeviceGeneralSettingCommand : ConfigApiCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (generalSettings == null)
            {
                WriteError(
                    new ErrorRecord(
                        new ItemNotFoundException($"General Settings not found for {name}"),
                        string.Empty,
