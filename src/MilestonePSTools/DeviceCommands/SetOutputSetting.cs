...
{
    [Cmdlet(VerbsCommon.Set, "OutputSetting")]
    [RequiresVmsConnection()]
    public class SetOutputSetting : ConfigApiCmdlet
    {
        ...
        {
            var settings = Output.DeviceDriverSettingsFolder.DeviceDriverSettings.First();
