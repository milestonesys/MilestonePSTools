...
{
    [Cmdlet(VerbsCommon.Set, "InputSetting")]
    [RequiresVmsConnection()]
    public class SetInputSetting : ConfigApiCmdlet
    {
        ...
        {
            var settings = Input.DeviceDriverSettingsFolder.DeviceDriverSettings.First();
