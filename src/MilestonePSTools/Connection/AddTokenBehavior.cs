...
namespace MilestonePSTools.Connection
{
    ...
    {
        private readonly IMipTokenCache _tokenCache;

        internal AddTokenBehavior(IMipTokenCache tokenCache)
        {
        ...
        {
            clientRuntime.MessageInspectors.Add(new BearerAuthorizationHeaderInspector(_tokenCache.Token));
        }
        ...
        {
            return new AddTokenBehavior(_tokenCache);
        }
    }
